...
public class InitStyles implements CommandLineRunner {
    ...
    private final Map<StyleName, String> stylesDescrptions = Map.of(
    ...
    public void run(String... args) throws Exception {
        ...
        for (StyleName styleName : stylesDescrptions.keySet()) {
            Style style = new Style(styleName, stylesDescrptions.get(styleName));
